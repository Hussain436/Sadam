...
icon = Image.open("C:\\Users\\Admin\\OneDrive\\Desktop\\youtube.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By SADAM HUSSAIN",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *SADAM HUSSAIN!*"""})

# CREATING OPTION MENU
with st.sidebar:
    selected = option_menu(None, ["Home","Mine & Transform","View queries"], 
                           ...
                           styles={"nav-link": {"font-size": "15px", "text-align": "centre", "margin": "0px", 
                                   ...
                                   "nav-link-selected": {"background-color": "#800000"}})
#conneting to Mongodb    

client = pymongo.MongoClient("localhost:27017")
db = client.Youtube_Data_Sadam   
...
api_key = "AIzaSyC4K4vIKYwjteDpjNP98ljik82MReME49E" #"AIzaSyC4K4vIKYwjteDpjNP98ljik82MReME49E" 
...
# MINE AND TRANSFORM PAGE
if selected == "Mine & Transform":
    tab1,tab2 = st.tabs(["$\huge 📝 Mine $", "$\huge🚀 TRANSFORM $"])
    ...
    with tab1:
        ...
        if ch_id and st.button("Mine Data"):
            ch_details = get_channel_details(ch_id)
            st.write(f'#### Mined data from :green["{ch_details[0]["Channel_name"]}"] channel')
            st.table(ch_details)
